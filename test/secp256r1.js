...
contract.only('Secp256r1.js', (accounts) => {
    ...
    describe('Verify Public Key Signature', async () => {
        it.only('Verify P256 Signature', async () => {
            const X = toBigNumber(new BigNumber("a6ad1deeababc22e1eeba4bc93f6535ff95391a1981d9276bbe39b1ce473d6ed", 16));
            const Y = toBigNumber(new BigNumber("688c2d5b0231d21e9f6ad264cfcdcf09aec15ea8c5c354f38b2fae95e82959e4", 16));
            ...
            let res = await secp256r1.Verify(X, Y, hash, R, S);
            console.log(res)
        })
    })
    ...
    describe('Basic EC Operations', async () => {
        ...
        it.only('Ec Point Addition', async () => {
            // Test data generated by golang crypto/elliptic library
            // var ECADD_TEST_DATA = require('./data/add-jacobian.json');
            var ECADD_TEST_DATA = {
                "test1":{
                    "input":["f6221e371ef1f084b4cf38b4d0c19c7a1b5f2ea27e703d11d6a5eabde97cb897","beddbe86675f1de5896aa3a773d781bffcd17e328823b1d2574dab46656b74a0","d4b4ca00d9238dfc7495a3833dd46e3f36762e0cc02296de78d1f8a9e4be7e75",
                    "36eaaf04c4c971eb2d433a9b14055a044cb570beb3f868307dbbf70db00f0ca5"]
                }
            };
        ...
        it('Affine from Jacobian', async () => {
            ...
            for (var i in ECADD_TEST_DATA) {
                ...
                let res = await secp256r1._affineJacobian(x, y, z);
        ...
        it('Hash to Integer', async () => {
            ...
            for (var i in ECADD_TEST_DATA) {
                ...
                console.log(res)
                // console.log(res[0].toString(16), xx.toString(10).slice(2));
                // console.log(res[1].toString(16), yy.toString(10).slice(2));
             }
        })

        it.only('Inverse modulo', async () => {
            var ECADD_TEST_DATA = {
                "test1": {
