...
contract.only('Secp256r1.js', (accounts) => {
    ...
    describe('ECCurve Test', async () => {
        ...
        it.only('Jacobian Double', async () => {
            ...
            //     },
            //     "old-test3": {
            //         "input": ["cef6d0ff4ac3b92c5a948c2c686c1f776b7a5e28a220e42adffa013e22d863b9", "ebc80e5d0206cf4f18c5e6a787fd7588bd4573d57fcaad85b190cd8d8d72521f", "1"],
            //         "output": ["ce716c51f920c229d2651f218d8a2fa861d31a440c6c0437a01b45ffa23fd99f", "f931badf2b37a352438b2e1e22762e4d40b81872d90ac2d8f9147696e4c848f7", "d7901cbb040d9e9d318bcd4f0ffaeb117a8ae7a9ff955b0b63219b1b1ae4a43f"]
            //     },
            //     "test2": {
            //         "input":["9cb73fe3e7264f5438d4f209fc140edbc26660560e9579b6cc28c9deb6a4cb36","a7bc8fec623f7dcededc89f8138f4a03924adbfa7b69e7000ce99c65e14e2526","1"],
            //         "output":["8e6da8dd823044798bcd59f3f09d5545057d68ac9711048c73531d4c176381f4","8ec0425b0e13400f5c473862535000ee86079d11bf2f664b3ee201ea8ebecb3a","4f791fd9c47efb9cbdb913f0271e94072495b7f3f6d3ce0019d338cbc29c4a4d"]
            //     }
            // };
            let fixture;
            for (var i in ECADD_TEST_DATA) {
                ...
                let res = await secp256r1._mdbl_2007_bl(P[0], P[1], P[2]);
                // console.log(res);
                // console.log(res[0].toString(16), x3.toString(10).slice(2));
                // console.log(res[1].toString(16), y3.toString(10).slice(2));
                // console.log(res[2].toString(16), z3.toString(10).slice(2));
